...
class StepExecutionReportMapper {
    ...
    static StepExecutionReportDto toDto(StepExecutionReport report) {
        return new StepExecutionReportDto(
            ...
            StepContextMapper.toDto(report.scenarioContext, report.evaluatedInputs, report.stepResults, report.evaluatedInputsSnapshot, report.stepResultsSnapshot),
            report.type,
            report.targetName,
            report.targetUrl,
            report.strategy
    ...
    static class StepContextMapper {
        ...
        static StepExecutionReportDto.StepContextDto toDto(Map<String, Object> scenarioContext, Map<String, Object> evaluatedInput, Map<String, Object> stepResults, Map<String, String> evaluatedInputSnapshot, Map<String, String> stepResultsSnapshot) {
